...
function InventoryApp() {
  ...
  return (
    <div className="react-inventory-container bg-slate-950 text-slate-100 min-h-full flex flex-col font-sans w-full overflow-hidden">
      {/* Top Header */}
      ...
      <div className="bg-slate-900 text-white py-2 px-3 border-t border-slate-800 flex justify-around items-center z-40">
        <button
          ...
          className={`flex flex-col items-center justify-center p-1 font-mono tracking-tighter ${activeScreen === 'Inventory Management' || activeScreen === 'Item Details' ? 'text-sky-400 font-bold' : 'text-slate-400 hover:text-white transition'
            }`}
        >
          <Package size={15} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1 font-mono tracking-tighter ${activeScreen === 'Warehouse Locations' ? 'text-sky-400 font-bold' : 'text-slate-400 hover:text-white transition'
            }`}
        >
          <Briefcase size={15} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1 font-mono tracking-tighter ${activeScreen === 'Purchase Orders' || activeScreen === 'PODetails' || activeScreen === 'New Purchase Orders' || activeScreen === 'Suppliers' ? 'text-sky-400 font-bold' : 'text-slate-400 hover:text-white transition'
            }`}
        >
          <Truck size={15} />
